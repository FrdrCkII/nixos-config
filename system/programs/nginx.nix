...
server {
    ...
    ssl_certificate /data/_Tools/steamcommunity_302/steamcommunity.crt;# 设置证书,这里使用了相对路径,绝对路径也行
    ssl_certificate_key /data/_Tools/steamcommunity_302/steamcommunity.key;# 设置与证书匹配的密钥,同上
